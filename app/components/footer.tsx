...
const Footer = () => {
    return (
        <footer className="bg-[#f1f3fb] text-black pb-8 fade-in">
            <div className="container mx-auto px-6">
                <div className="text-center mt-6">
                    <div className="pb-[20px]">
                        <Link href="/assets/CV ATS MUHAMAD ZAKY P A V2.pdf">
                            <StarBorder
                                as="button"
                    ...
                    <div className="flex justify-center items-center space-x-4">
                        <a href="https://www.linkedin.com/in/muhamad-zaky-priambada-anugrah/" target="_blank" rel="noopener noreferrer">
                            <img
                                ...
                                width="30"
                                alt="LinkedIn"
                                className="transition-all duration-300 hover:shadow-lg hover:scale-110 filter brightness-0 hover:brightness-30"
                            />
                        </a>
